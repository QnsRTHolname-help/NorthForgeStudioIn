...
export function LogoMark({ className, size = 28 }: { className?: string; size?: number }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="nf-mark" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="rgb(var(--nf-blue))" />
          <stop offset="100%" stopColor="rgb(var(--nf-violet))" />
        </linearGradient>
      </defs>
      <rect x="0.75" y="0.75" width="38.5" height="38.5" rx="9" fill="rgb(var(--nf-surface))" stroke="url(#nf-mark)" strokeWidth="1.5" />
      <path
        d="M11.5 28.5V11.5L20 21.5V11.5H22V28.5H20L11.5 18.5V28.5Z"
        fill="rgb(var(--nf-fg))"
      />
      <path d="M26 28.5V11.5H30.5V16H28.2V13.7H28.1V28.5Z" fill="url(#nf-mark)" />
      <path d="M26 19.6H30.4V21.9H26Z" fill="url(#nf-mark)" />
    </svg>
  );
}
